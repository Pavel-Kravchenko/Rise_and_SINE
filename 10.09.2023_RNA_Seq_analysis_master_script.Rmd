...
working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Nr5a2_Gassler/Developmental_RNA_SEQ_data"

#loading methadata
samples_methadata <- read.csv(file.path(working_dir, "samples.csv"), header = TRUE, sep=";")

samples_methadata = samples_methadata[samples_methadata["Line"] == "C57BL_6J",]
...
write.table(txi.kallisto$counts,file=paste0(working_dir, "/release/txi.kallisto_counts_raw_genes.csv"),row.names=T,quote=F,sep="\t")
samples_methadata
...
fpkmdds$Zygote_G2 = apply(fpkmdds[, samples_methadata$sample_name[samples_methadata["condition"] == "Zygote_G2"]],1,mean)
fpkmdds$`2cell_G2` = apply(fpkmdds[, samples_methadata$sample_name[samples_methadata["condition"] == "2cell_G2"]],1,mean)
fpkmdds = fpkmdds %>% select(c("Zygote_G2", "2cell_G2"))
colnames(fpkmdds) = c("Zygote_G2_FPKM", "2cell_G2_FPKM")

abdds = as.data.frame(txi.kallisto$abundance)
abdds$Zygote_G2 = apply(abdds[, samples_methadata$sample_name[samples_methadata["condition"] == "Zygote_G2"]],1,mean)
abdds$`2cell_G2` = apply(abdds[, samples_methadata$sample_name[samples_methadata["condition"] == "2cell_G2"]],1,mean)
abdds = abdds %>% dplyr::select(c("Zygote_G2", "2cell_G2"))
colnames(abdds) = c("Zygote_Ab", "2cell_Ab")

source("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/readKallisto.R")
files <- dir("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Nr5a2_Gassler/Developmental_RNA_SEQ_data", "abundance.tsv", full=TRUE,
             recursive=TRUE)
...
tpmdds$Zygote_G2 = apply(tpmdds[, samples_methadata$sample_name[samples_methadata["condition"] == "Zygote_G2"]],1,mean)
tpmdds$`2cell_G2` = apply(tpmdds[, samples_methadata$sample_name[samples_methadata["condition"] == "2cell_G2"]],1,mean)
tpmdds = tpmdds %>% dplyr::select(c("Zygote_G2", "2cell_G2"))
colnames(tpmdds) = c("Zygote_G2_TPM", "2cell_G2_TPM")
tpmdds$ENTREZID = rownames(tpmdds) 
tpmdds = tidyr::separate(tpmdds, col="ENTREZID", into = c("ENTREZID", "ENTREZID_dot")) %>% dplyr::select(c("ENTREZID", "Zygote_G2_TPM", "2cell_G2_TPM"))
...
myResS <- results(ddsSalmon, contrast = c("condition", "Zygote_G2", "2cell_G2"))
...
write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/release/annotatedRes_log2FC_C57BL_6J_genes.csv"),row.names=T,quote=F,sep="\t")
```
...
samples_methadata = samples_methadata[samples_methadata["Line"] == "B6xCAST",]


temp <- read.delim("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Nr5a2_Gassler/Developmental_RNA_SEQ_data/Kallisto/C57BL_6J_72593_WT_ZygG2/abundance.tsv")
...
# Tx2Gene[1:10, ]
# conflict_prefer("select", "dplyr")
# Tx2Gene = tidyr::separate(Tx2Gene, col="TXNAME", into = c("TXNAME", "TXNAME_dot")) %>% select(c("TXNAME", "GENEID"))
# Tx2Gene[1:10, ]

#gtf.gr = rtracklayer::import("/Volumes/pool-totipotency/Totipotency_screen/Science_resubmission_22/C88_analysis/data/rna_seq/rna_seq_indices/mm10/Kallisto_index/ensembl_v96/Mus_musculus.GRCm38.96.gtf")
gtf.df = as.data.frame(gtf.gr)
txt2gene=(gtf.df[gtf.df$type=='transcript' ,c("transcript_id","gene_name")])
names(txt2gene)<-c('TXNAME','GENEID')
...
#txi.kallisto_tpm <- tximport(kallisto_files, type = "kallisto", txOut = F, tx2gene = txt2gene, ignoreTxVersion = TRUE, ignoreAfterBar=TRUE, countsFromAbundance = "scaledTPM")
...
annotatedRes_fpkmdds <- merge(annotatedRes_fpkmdds,abdds,
                      by.x=1,
                      by.y=0,
                      all.x=TRUE,
                      all.y=FALSE)

write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/release/annotatedRes_log2FC_B6xCAST_genes.csv"),row.names=T,quote=F,sep="\t")
...
annotatedRes_B6xCAST = read.csv(file=paste0(working_dir, "/release/annotatedRes_log2FC_B6xCAST_genes.csv"),sep="\t")
annotatedRes_B6xCAST %<>% dplyr::filter((log2FoldChange < 2) & (newPadj < 0.01) & (Zygote_G2_TPM > 0.5) & (X2cell_G2_TPM > 50))

annotatedRes_C57XBL_6J = read.csv(file=paste0(working_dir, "/release/annotatedRes_log2FC_C57BL_6J_genes.csv"),sep="\t")
annotatedRes_C57XBL_6J %<>% dplyr::filter((log2FoldChange < 2) & (newPadj < 0.01) & (Zygote_G2_TPM > 0.5) & (X2cell_G2_TPM > 50))

```

```{r}

length(annotatedRes_B6xCAST$SYMBOL)
length(annotatedRes_C57XBL_6J$SYMBOL)
...
```{r}
gene_list <- list(
  "B6xCAST" = unique(toupper(annotatedRes_B6xCAST$SYMBOL)),
  "C57BL_6J" = unique(toupper(annotatedRes_C57XBL_6J$SYMBOL)))

library(eulerr)
p <- plot(euler(gene_list), quantities = TRUE)
print(p)
...
#setting up environment
working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Hu_from_Xie"
...
source("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/readKallisto.R")
files <- dir("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Hu_from_Xie", "abundance.tsv", full=TRUE,
             recursive=TRUE)
stopifnot(all(file.exists(files)))
files <- sub(".tsv", ".h5", files, fixed=TRUE)
exp = readKallisto(files, what=c("tpm", "eff_length"), as="SummarizedExperiment")
...
write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Hu_genes.csv"),row.names=T,quote=F,sep="\t")
...
annotatedRes_Hu = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Hu_genes.csv"),sep="\t")
annotatedRes_Hu %<>% dplyr::filter((log2FoldChange < 2) & (newPadj < 0.01) & (Zygote_TPM > 0.5) & (X2cell_TPM > 50))
...
gene_list <- list(
  ...
  "C57BL_6N Xie" = unique(toupper(annotatedRes_Hu$SYMBOL)))
...
#setting up environment
working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Obox_Shuyan"
...
source("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/readKallisto.R")
files <- dir("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Obox_Shuyan", "abundance.tsv", full=TRUE,
             recursive=TRUE)
stopifnot(all(file.exists(files)))
files <- sub(".tsv", ".h5", files, fixed=TRUE)
exp = readKallisto(files, what=c("tpm", "eff_length"), as="SummarizedExperiment")
...
write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Obox_Shuyan_genes.csv"),row.names=T,quote=F,sep="\t")
```
...
annotatedRes_Shuyan = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Obox_Shuyan_genes.csv"),sep="\t")
annotatedRes_Shuyan %<>% dplyr::filter((log2FoldChange < 2) & (newPadj < 0.01) & (Zygote_TPM > 0.5) & (X2cell_TPM > 50))
...
#setting up environment
working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Yu"
...
source("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/readKallisto.R")
files <- dir("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Yu", "abundance.tsv", full=TRUE,
             recursive=TRUE)
stopifnot(all(file.exists(files)))
files <- sub(".tsv", ".h5", files, fixed=TRUE)
exp = readKallisto(files, what=c("tpm", "eff_length"), as="SummarizedExperiment")
...
write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Yu_genes.csv"),row.names=T,quote=F,sep="\t")
```
...
annotatedRes_Yu = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Yu_genes.csv"),sep="\t")
annotatedRes_Yu %<>% dplyr::filter((log2FoldChange < 2) & (newPadj < 0.01) & (Zygote_TPM > 0.5) & (X2cell_TPM > 50))
...
gene_list <- list(
  ...
  "C57BL_6N Xie" = unique(toupper(annotatedRes_Hu$SYMBOL)),
  "C57BL_6 Shuyan" = unique(toupper(annotatedRes_Shuyan$SYMBOL)),
  "ZGA Yu" = unique(toupper(annotatedRes_Yu$SYMBOL)))
...
#setting up environment
working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Wang"
...
write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Wang_genes.csv"),row.names=T,quote=F,sep="\t")
```
```{r}
library(dplyr)
library(magrittr)
...
annotatedRes_Wang = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Wang_genes.csv"),sep="\t")
annotatedRes_Wang %<>% dplyr::filter((log2FoldChange < 2) & (newPadj < 0.01) & (Zygote_TPM > 0.5) & (X2cell_TPM > 50))
...
#setting up environment
working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Wu"
...
source("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/readKallisto.R")
files <- dir("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Wu", "abundance.tsv", full=TRUE,
             recursive=TRUE)
stopifnot(all(file.exists(files)))
files <- sub(".tsv", ".h5", files, fixed=TRUE)
exp = readKallisto(files, what=c("tpm", "eff_length"), as="SummarizedExperiment")
...
write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Wu_genes.csv"),row.names=T,quote=F,sep="\t")
```
...
annotatedRes_Wu = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Wu_genes.csv"),sep="\t")
annotatedRes_Wu %<>% dplyr::filter((log2FoldChange < 2) & (newPadj < 0.01) & (Zygote_TPM > 0.5) & (X2cell_TPM > 50))
...
#setting up environment
working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Zhang"
...
source("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/readKallisto.R")
files <- dir("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Zhang", "abundance.tsv", full=TRUE,
             recursive=TRUE)
stopifnot(all(file.exists(files)))
files <- sub(".tsv", ".h5", files, fixed=TRUE)
exp = readKallisto(files, what=c("tpm", "eff_length"), as="SummarizedExperiment")
...
write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Zhang_genes.csv"),row.names=T,quote=F,sep="\t")
```
...
#setting up environment
working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Dux_KO_Chen_single"
...
source("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/readKallisto.R")
files <- dir("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Dux_KO_Chen_single", "abundance.tsv", full=TRUE,
             recursive=TRUE)
stopifnot(all(file.exists(files)))
files <- sub(".tsv", ".h5", files, fixed=TRUE)
exp = readKallisto(files, what=c("tpm", "eff_length"), as="SummarizedExperiment")
...
write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Chen_genes.csv"),row.names=T,quote=F,sep="\t")
```
...
#setting up environment
working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Deng_single"
...
source("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/readKallisto.R")
files <- dir("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Deng_single", "abundance.tsv", full=TRUE,
             recursive=TRUE)
stopifnot(all(file.exists(files)))
files <- sub(".tsv", ".h5", files, fixed=TRUE)
exp = readKallisto(files, what=c("tpm", "eff_length"), as="SummarizedExperiment")
...
write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Deng_genes.csv"),row.names=T,quote=F,sep="\t")
```
```{r}
#solving some conflicts
conflict_prefer("mutate", "dplyr")
...
#setting up environment
working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Guo"
...
source("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/readKallisto.R")
files <- dir("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Guo", "abundance.tsv", full=TRUE,
             recursive=TRUE)
stopifnot(all(file.exists(files)))
files <- sub(".tsv", ".h5", files, fixed=TRUE)
exp = readKallisto(files, what=c("tpm", "eff_length"), as="SummarizedExperiment")
...
write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Guo_genes.csv"),row.names=T,quote=F,sep="\t")
```
...
#setting up environment
working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Zhang_2016"
...
source("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/readKallisto.R")
files <- dir("/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Zhang_2016", "abundance.tsv", full=TRUE,
             recursive=TRUE)
stopifnot(all(file.exists(files)))
files <- sub(".tsv", ".h5", files, fixed=TRUE)
exp = readKallisto(files, what=c("tpm", "eff_length"), as="SummarizedExperiment")
...
write.table(annotatedRes_fpkmdds,file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Zhang_2016_genes.csv"),row.names=T,quote=F,sep="\t")
```
...
annotatedRes_B6xCAST = read.csv(file=paste0(working_dir, "/release/annotatedRes_log2FC_B6xCAST_genes.csv"),sep="\t")
annotatedRes_B6xCAST %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_G2_FPKM > v_1cell_threshold) & (X2cell_G2_FPKM > v_2cell_threshold))

annotatedRes_C57XBL_6J = read.csv(file=paste0(working_dir, "/release/annotatedRes_log2FC_C57BL_6J_genes.csv"),sep="\t")
annotatedRes_C57XBL_6J %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_G2_FPKM > v_1cell_threshold) & (X2cell_G2_FPKM > v_2cell_threshold))
...
annotatedRes_Hu = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Hu_genes.csv"),sep="\t")
annotatedRes_Hu %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_FPKM > v_1cell_threshold) & (X2cell_FPKM > v_2cell_threshold))
...
annotatedRes_Shuyan = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Obox_Shuyan_genes.csv"),sep="\t")
annotatedRes_Shuyan %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_FPKM > v_1cell_threshold) & (X2cell_FPKM > v_2cell_threshold))
...
annotatedRes_Yu = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Yu_genes.csv"),sep="\t")
annotatedRes_Yu %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_FPKM > v_1cell_threshold) & (X2cell_FPKM > v_2cell_threshold))
...
annotatedRes_Wang = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Wang_genes.csv"),sep="\t")
annotatedRes_Wang %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_FPKM > v_1cell_threshold) & (X2cell_FPKM > v_2cell_threshold))
...
annotatedRes_Wu = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Wu_genes.csv"),sep="\t")
annotatedRes_Wu %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_FPKM > v_1cell_threshold) & (X2cell_FPKM > v_2cell_threshold))
...
annotatedRes_Zhang = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Zhang_genes.csv"),sep="\t")
annotatedRes_Zhang %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_FPKM > v_1cell_threshold) & (X2cell_FPKM > v_2cell_threshold))
...
annotatedRes_Chen = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Chen_genes.csv"),sep="\t")
annotatedRes_Chen %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_FPKM > v_1cell_threshold) & (X2cell_FPKM > v_2cell_threshold))


working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Deng_single"


annotatedRes_Deng = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Deng_genes.csv"),sep="\t")
annotatedRes_Deng %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_FPKM > v_1cell_threshold) & (X2cell_FPKM > v_2cell_threshold))

working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Guo"


annotatedRes_Guo = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Guo_genes.csv"),sep="\t")
annotatedRes_Guo %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_FPKM > v_1cell_threshold) & (X2cell_FPKM > v_2cell_threshold))


working_dir="/Volumes/pool-toti-bioinfo/bioinfo/Pavel.Kravchenko/ZGA_Zhang_2016"


annotatedRes_Zhang_2016 = read.csv(file=paste0(working_dir, "/annotatedRes_log2FC_ZGA_Zhang_2016_genes.csv"),sep="\t")
annotatedRes_Zhang_2016 %<>% dplyr::filter((log2FoldChange < log2FoldChange_threshold) & (newPadj < v_pval_threshold) & (Zygote_FPKM > v_1cell_threshold) & (X2cell_FPKM > v_2cell_threshold))
