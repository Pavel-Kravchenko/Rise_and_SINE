...
cnt4 = processRNA_Seq(home, "ZGA_Yu_et_al_ICR_GSE71257_paired_polyA", gtf.gr)
cnt5 = processRNA_Seq(home, "ZGA_Wu_et_al_C57BL_6NxDBA_2N_GSE66582_paired_polyA", gtf.gr)
cnt6 = processRNA_Seq(home, "ZGA_Chen_et_al_B6D2F1_GSE121746_single_polyA", gtf.gr)
cnt7 = processRNA_Seq(home, "ZGA_Deng_et_al_CAST_EiJxC57BL_6J_GSE45719_single_polyA", gtf.gr)
cnt8 = processRNA_Seq(home, "ZGA_Guo_et_al_C57BL_6_GSE134832_paired_polyA", gtf.gr)
cnt9 = processRNA_Seq(home, "ZGA_Zhang_et_al_C57BL_6NxPWK_PhJ_GSE71434_paired_polyA", gtf.gr)
cnt10 = processRNA_Seq(home, "ZGA_Zhang_et_al_B6D2F1_J_GSE169632_paired_total", gtf.gr)
```

# Checking integrity
```{r}

df_vector = list(cnt1, cnt2, cnt3, cnt4, cnt5, cnt6, cnt7, cnt8, cnt9, cnt10) 
names_vector = c(rep("Gassler_et_al_C57BL_6J", ncol(cnt1)), 
                 rep("Gassler_et_al_B6xCAST", ncol(cnt2)), 
                 rep("Ji_et_al_C57BL_6", ncol(cnt3)), 
                 rep("Yu_et_al_ICR", ncol(cnt4)), 
                 rep("Wu_et_al_C57BL_6NxDBA_2N", ncol(cnt5)), 
                 rep("Chen_et_al_B6D2F1", ncol(cnt6)), 
                 rep("Deng_et_al_CAST_EiJxC57BL_6J", ncol(cnt7)), # IVF dataset
                 rep("Guo_et_al_C57BL_6", ncol(cnt8)), 
                 rep("Zhang_et_al_C57BL_6NxPWK_PhJ", ncol(cnt9)), 
                 rep("Zhang_et_al_B6D2F1_J (total)", ncol(cnt10)))
...
annotatedRes_Gassler_C57XBL_6J = read_and_threshold_ZGA_genes(home, "ZGA_Gassler_et_al_C57BL_6J_GSE178638_paired_polyA", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Gassler_B6xCAST = read_and_threshold_ZGA_genes(home, "ZGA_Gassler_et_al_B6xCAST_GSE178638_paired_polyA", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Ji = read_and_threshold_ZGA_genes(home, "ZGA_Ji_et_al_C57BL_6_GSE215813_paired_polyA", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Yu = read_and_threshold_ZGA_genes(home, "ZGA_Yu_et_al_ICR_GSE71257_paired_polyA", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Wu = read_and_threshold_ZGA_genes(home, "ZGA_Wu_et_al_C57BL_6NxDBA_2N_GSE66582_paired_polyA", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Zhang_total = read_and_threshold_ZGA_genes(home, "ZGA_Zhang_et_al_B6D2F1_J_GSE169632_paired_total", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Chen = read_and_threshold_ZGA_genes(home, "ZGA_Chen_et_al_B6D2F1_GSE121746_single_polyA", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Deng = read_and_threshold_ZGA_genes(home, "ZGA_Deng_et_al_CAST_EiJxC57BL_6J_GSE45719_single_polyA", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Guo = read_and_threshold_ZGA_genes(home, "ZGA_Guo_et_al_C57BL_6_GSE134832_paired_polyA", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Zhang = read_and_threshold_ZGA_genes(home, "ZGA_Zhang_et_al_C57BL_6NxPWK_PhJ_GSE71434_paired_polyA", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
```
...
gene_list <- list(
  ...
  "B6D2F1_J Zhang (total)" = unique(toupper(annotatedRes_Zhang_total$SYMBOL)),
...
nVennR_gene_list_polyA <- list(
  ...
  "C57BL/6 clean (3)" = unique(Reduce(c,list(unique(toupper(annotatedRes_Ji$SYMBOL)), unique(toupper(annotatedRes_Gassler_C57XBL_6J$SYMBOL)),unique(toupper(annotatedRes_Guo$SYMBOL))))),
...
$$
Pan \ ZGA \ list = \bigcup_{ \forall k ∈𝔸}^{} (\bigcap_{\forall \alpha ∈𝔸} ZGA \ list \ \alpha, \bigcap_{ \forall \alpha ∈𝔸\backslash k} ZGA \ list \ \alpha), \ where \ 𝔸 \ is \ a \ set \ of \ ZGA \ datasets
$$
...
for (i in seq(length(gene_list))){
  print(i)
  cc = c(cc, nrow(fromList(gene_list[- i])[apply(fromList(gene_list[- i]),1,sum) > 8, ]))
}
...
# Checking Pan categories
```{r}
cc = c(nrow(fromList(nVennR_gene_list_polyA)[apply(fromList(nVennR_gene_list_polyA),1,sum) > 3, ]))

for (i in seq(length(nVennR_gene_list_polyA))){
  print(i)
  cc = c(cc, nrow(fromList(nVennR_gene_list_polyA[- i])[apply(fromList(nVennR_gene_list_polyA[- i]),1,sum) > 3, ]))
}
...
```{r}
nVennR_gene_list_polyA <- list(
  "C57BL/6 clean (N=3)" = unique(Reduce(c,list(unique(toupper(annotatedRes_Ji$SYMBOL)), unique(toupper(annotatedRes_Gassler_C57XBL_6J$SYMBOL)),unique(toupper(annotatedRes_Guo$SYMBOL))))),
  "C57BL/6 x mix (N=3)" = unique(Reduce(intersect,list(unique(toupper(annotatedRes_Gassler_B6xCAST$SYMBOL)),
                                                 unique(toupper(annotatedRes_Wu$SYMBOL)),
                                              unique(toupper(annotatedRes_Zhang$SYMBOL))))),
  "CAST/EiJxC57BL/6J (N=1)" = unique(toupper(annotatedRes_Deng$SYMBOL)),
...
pdf("./figures/NRs_Dux_Obox_Pan_ZGA_gene_list_polyA_UpSetR_plot.pdf")
set_size(8, 5)
size = get_size_mode('exclusive_intersection')
...
write.csv(pc[pc$cnt > 3, ], "./Pan_4_degre_ZGA_genes.csv", row.names=FALSE)
write.csv(pc[pc$cnt > 2, ], "./Pan_3_degree_ZGA_genes.csv", row.names=FALSE)
write.csv(pc[pc$cnt > 1, ], "./Pan_2_degree_ZGA_genes.csv", row.names=FALSE)
write.csv(pc[pc$cnt == 5, ], "./Core_ZGA_genes.csv", row.names=FALSE)
