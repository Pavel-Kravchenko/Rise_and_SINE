...
$$
Pan \ ZGA \ list = \{ \bigcap_{\alpha = 1}^{𝔸} Z \alpha\} \bigcup_{}^{} \{\bigcup_{\alpha = 1}^{𝔸}\{\bigcap_{ \alpha \neq k \atop \forall \alpha ∈𝔸} Z \alpha\}\}, \ where \ 𝔸 \ is \ a \ set \ of \ ZGA \ datasets \ Z1, Z2, ... ,Zn
$$
...
write.csv(pc[pc$cnt > 2, ], "./tables/Pan_1_degree_ZGA_genes.csv", row.names=FALSE)
write.csv(pc[pc$cnt > 1, ], "./tables/Pan_2_degree_ZGA_genes.csv", row.names=FALSE)
write.csv(pc[pc$cnt > 0, ], "./tables/Pan_3_degree_ZGA_genes.csv", row.names=FALSE)
write.csv(pc[pc$cnt == 4, ], "./tables/Core_ZGA_genes.csv", row.names=FALSE)
write.csv(pc, "./tables/Complete_ZGA_genes.csv", row.names=FALSE)
