...
processRNA_Seq(home, "ZGA_Gassler_et_al_C57BL_6J_GSE178638_paired_polyA", gtf.gr)
processRNA_Seq(home, "ZGA_Gassler_et_al_B6xCAST_GSE178638_paired_polyA", gtf.gr)
processRNA_Seq(home, "ZGA_Ji_et_al_C57BL_6_GSE215813_paired_polyA", gtf.gr)
processRNA_Seq(home, "ZGA_Yu_et_al_ICR_GSE71257_paired_polyA", gtf.gr)
processRNA_Seq(home, "ZGA_Wu_et_al_C57BL_6NxDBA_2N_GSE66582_paired_polyA", gtf.gr)
processRNA_Seq(home, "ZGA_Chen_et_al_B6D2F1_GSE121746_single_polyA", gtf.gr)
processRNA_Seq(home, "ZGA_Deng_et_al_CAST_EiJxC57BL_6J_GSE45719_single_polyA", gtf.gr)
processRNA_Seq(home, "ZGA_Guo_et_al_C57BL_6_GSE134832_paired_polyA", gtf.gr)
processRNA_Seq(home, "ZGA_Zhang_et_al_C57BL_6NxPWK_PhJ_GSE71434_paired_polyA", gtf.gr)
processRNA_Seq(home, "ZGA_Zhang_et_al_B6D2F1_J_GSE169632_paired_total", gtf.gr)
```
...
annotatedRes_Hu = read_and_threshold_ZGA_genes(home, "ZGA_Hu_from_Xie", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Shuyan = read_and_threshold_ZGA_genes(home, "ZGA_Obox_Shuyan", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Yu = read_and_threshold_ZGA_genes(home, "ZGA_Yu", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Wang = read_and_threshold_ZGA_genes(home, "ZGA_Wang", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Wu = read_and_threshold_ZGA_genes(home, "ZGA_Wu", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Zhang = read_and_threshold_ZGA_genes(home, "ZGA_Zhang", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Chen = read_and_threshold_ZGA_genes(home, "ZGA_Dux_KO_Chen_single", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Deng = read_and_threshold_ZGA_genes(home, "ZGA_Deng_single", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Guo = read_and_threshold_ZGA_genes(home, "ZGA_Guo", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
annotatedRes_Zhang_2016 = read_and_threshold_ZGA_genes(home, "ZGA_Zhang_2016", v_1cell_threshold, v_2cell_threshold, v_pval_threshold, log2FoldChange_threshold)
```
...
ZGA_Chen_et_al <- file.path("./41588_2019_418_MOESM3_ESM.xlsx")
...
res_mm = read.delim("./science.abn7478_table_s6.csv", sep = ";")
nr5a2_kd = unique(res_mm[which(res_mm$State == "DOWN"),]$gene_id)

res_mm = read.delim("./science.abn7478_table_s5.csv", sep = ";")
...
res_mm = read.delim("./41586_2023_6428_MOESM3_ESM.csv", sep = ";")
...
write.csv(pc[pc$cnt > 3, ], "./Pan_ZGA_genes.csv", row.names=FALSE)
write.csv(pc[pc$cnt == 5, ], "./Common_ZGA_genes.csv", row.names=FALSE)
