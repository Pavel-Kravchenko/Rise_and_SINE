...
pdf("nVennR_gene_list_polyA_euler.pdf")
plot(euler(nVennR_gene_list_polyA, shape="ellipse"), quantities = TRUE, legend = TRUE)
dev.off()
plotVenn(nVennR_gene_list_polyA, outFile="plotVenn_polyA.svg")
...
pdf("nVennR_gene_list_polyA_UpSetR_plot.pdf")
set_size(8, 5)
...
geom_bar(stat="identity",colour=NA,linewidth=0)+
  ...
  geom_text(aes(label = cc), 
            angle = 45,
            nudge_y = range/3)
ggsave("gene_list_Pan_ZGA_barplot.pdf")
```
...
geom_bar(stat="identity",colour=NA,linewidth=0)+
  ...
  geom_text(aes(label = cc), 
            angle = 45,
            nudge_y = range/3)
ggsave("nVennR_gene_list_polyA_Pan_ZGA_barplot.pdf")
```
...
pdf("gene_list_polyA_euler.pdf")
plot(euler(gene_list_polyA_inter_uni, shape="ellipse"), quantities = TRUE, legend = TRUE)
dev.off()
plotVenn(nVennR_gene_list_polyA, outFile="gene_list_polyA_nvenn.svg")


pdf("gene_list_polyA_inter_uni_UpSetR_plot.pdf")
set_size(8, 5)
size = get_size_mode('exclusive_intersection')
